...
PeaShooterSingle::PeaShooterSingle(CRuntimeClass* theClass, CRuntimeClass* eject, int hp) : Plant(theClass, hp), ejectClass(eject) { 
}

void PeaShooterSingle::draw(HDC hDC) {
    Plant::draw(hDC);
}
